...
namespace MACROAPI_dot_net_test_harness
{
	...
	public class LoginAPI : System.Windows.Forms.Form
	{
        ...
        private RadioButton optNicky;
        private RadioButton optDavid;
		/// <summary>
		...
		private void InitializeComponent()
		{
            ...
            this.optNicky = new System.Windows.Forms.RadioButton();
            this.optDavid = new System.Windows.Forms.RadioButton();
            this.SuspendLayout();
            // 
            // lblUsername
            // 
            ...
            // optNicky
            // 
            this.optNicky.AutoSize = true;
            this.optNicky.Location = new System.Drawing.Point(14, 183);
            this.optNicky.Name = "optNicky";
            this.optNicky.Size = new System.Drawing.Size(52, 17);
            this.optNicky.TabIndex = 12;
            this.optNicky.TabStop = true;
            this.optNicky.Text = "Nicky";
            this.optNicky.UseVisualStyleBackColor = true;
            this.optNicky.CheckedChanged += new System.EventHandler(this.optNicky_CheckedChanged);
            // 
            // optDavid
            // 
            this.optDavid.AutoSize = true;
            this.optDavid.Location = new System.Drawing.Point(14, 201);
            this.optDavid.Name = "optDavid";
            this.optDavid.Size = new System.Drawing.Size(53, 17);
            this.optDavid.TabIndex = 13;
            this.optDavid.TabStop = true;
            this.optDavid.Text = "David";
            this.optDavid.UseVisualStyleBackColor = true;
            this.optDavid.CheckedChanged += new System.EventHandler(this.optDavid_CheckedChanged);
            // 
            // LoginAPI
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(336, 230);
            this.Controls.Add(this.optDavid);
            this.Controls.Add(this.optNicky);
            ...
            this.Load += new System.EventHandler(this.LoginAPI_Load);
        ...
        private void LoginAPI_Load(object sender, EventArgs e)
        {

        }

        // Switch to David's settings
        private void optDavid_CheckedChanged(object sender, EventArgs e)
        {
            if (optDavid.Checked)
            {
                txtUsername.Text = "rde";
                txtPassword.Text = "macrotm";
                txtDatabase.Text = "MACRODPH3";
                txtRole.Text = "MACROUser";
                txtSecConn.Text = "Provider=SQLOLEDB;Data Source=HOOKD;Initial Catalog = MainSecurity; User ID=sa; pwd=macrotm;";
                return;
            }
        }

        // Switch to Nicky's settings
        private void optNicky_CheckedChanged(object sender, EventArgs e)
        {
            if (optNicky.Checked)
            {
                txtUsername.Text = "n";
                txtPassword.Text = "n";
                txtDatabase.Text = "APITEST";
                txtRole.Text = "MACROUser";
                txtSecConn.Text = "";
                return;
            }
