Attribute VB_Name = "basMainMACROModuleCC"
'-----------------------------------------------------------------------------------------------'
...
#End If
    ...
    If blnLoginSucceeded Or blnShowUserInterface = False Then
        ...
        Dim CC As MACRO_CC.MACRO_CC
        
        Set CC = New MACRO_CC.MACRO_CC
        
        Call CC.Init(gsSecCon, goUser.CurrentDBConString, goUser.DatabaseCode, goUser.UserName, goUser.UserNameFull, _
        goUser.CheckPermission(gsFnCodeClinicalResponse), goUser.CheckPermission(gsFnImportClinicalDictionary), _
        goUser.CheckPermission(gsFnAutoencodeClinicalResponse))
        Set CC = Nothing
        End
