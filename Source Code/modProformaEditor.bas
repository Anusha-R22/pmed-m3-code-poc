Attribute VB_Name = "modProformaEditor"
'---------------------------------------------------------------------------------------------'
'   Copyright:  InferMed Ltd. 2006. All Rights Reserved
'   File:       modProformaEditor.bas
'   Author:     Nicky Johns, May 2006
'   Purpose:    AREZZO routines copied from modProformaEditor.bas
'           ONLY to be used in the ArezzoRebuild DLL (for the Study Copy Tool for 3.0.72)
'----------------------------------------------------------------------------------------------'
'
'----------------------------------------------------------------------------------------------'
'   NCJ 9 May 06 - Initial version copied from modProformaEditor.bas in SD
'------------------------------------------------------------------------------------'
Option Explicit
Option Base 0
...
Exit Sub
ErrHandler:
      Err.Raise Err.Number, , Err.Description & "|modProformaEditor.InsertProformaVisit"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.InsertProformaStudyVisitCRFPage"
...
Exit Sub
ErrHandler:
        Err.Raise Err.Number, , Err.Description & "|modProformaEditor.DeleteProformaStudyVisitCRFPage"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.SetVisitRepeats"
...
Exit Function
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.GetVisitRepeats"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.SetEFormRepeats"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.SetCyclingTask"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.DeleteProformaVisit"
        
End Sub

'------------------------------------------------------------------
Public Sub CreateProformaTrial(ByVal sClinicalTrialName As String)
'------------------------------------------------------------------
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.CreateProformaTrial"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.LoadProformaTrial"
...
Exit Function
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.gsCLMVisitName"
...
Exit Function
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.gnNewCLMPlan"
...
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.gnNewCLMDataItem"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.InsertProformaCRFPage"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.DeleteProformaCRFPage"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.DeleteProformaDataItem"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.UpdateProformaDataItem"
...
Exit Function
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.MTMToArezzoDataType"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.SaveProformaWarningCondition"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.SaveProformaWarningConditions"
...
Exit Sub
ErrHandler:
      Err.Raise Err.Number, , Err.Description & "|modProformaEditor.DeleteProformaWarningCondition"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.DeleteProformaWarningConditions"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.DeleteProformaRangeValues"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.SaveProformaRangeValue"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.DeleteProformaRangeValue"
...
Exit Sub
ErrHandler:
      Err.Raise Err.Number, , Err.Description & "|modProformaEditor.SaveProformaRangeValues"

End Sub

'------------------------------------------------------------------
Public Sub CloseProformaTrial()
'------------------------------------------------------------------
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.CloseProformaTrial"
...
Exit Sub
ErrHandler:
        Err.Raise Err.Number, , Err.Description & "|modProformaEditor.ShutDownCLM"
...
Dim oArezzoMemory As clsAREZZOMemory
    ...
    Call oArezzoMemory.Load(lStudyId, MacroConnectionString)
    
    Call goALM.StartALM(oArezzoMemory.AREZZOSwitches)
    
    ' NCJ 9 May 06 - Set temp directory for CLM
    ' Assume we're in the MACRO application directory
    goALM.TempDirectory = App.Path & "\Temp\"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.StartUpCLM"
...
Exit Sub
ErrHandler:
    Err.Raise Err.Number, , Err.Description & "|modProformaEditor.CopyProformaTrial"
