...
(
 ...
 @personid  int,
 @responsetaskid int,
 -- Mo 22/4/2008 bug 3025, double precision corrected to a decimal(16,10)
...
BEGIN
 ...
 BEGIN
  ...
  -- Mo 22/4/2008 bug 3025, update table corrected from DataItemResponse to DataItemResponseHistory
