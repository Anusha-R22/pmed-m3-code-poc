...
'   File:       Exchange_receive_data.asp
'   Author:     Andrew Newbigging
'   Purpose:    Used by TrialOffice for the purpose of receiving a patient data file
...
'	Nicky Johns 25/10/01 Added MLM's 2.1 changes
...
if err.number <> 0 then
	...
	if err.number <> 0 then
		...
		' NCJ 23 Dec 02 - Get current timestamp for next two DB operations
