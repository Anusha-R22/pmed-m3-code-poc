'--------------------------------------------------------------------------------
' File:         MACROAIStop.vbs
' Copyright:    InferMed Ltd. 2000. All Rights Reserved
' Author:       Richard Meinesz, June 2002
' Purpose:      Script to update the AutoImportControl table START/STOP field to STOP
'---------------------------------------------------------------------------------
...
Connect.Execute "UPDATE AutoImportControl SET STARTSTOP='STOP', WAITINTERVAL=" & lWaitInterval
